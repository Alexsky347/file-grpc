...
2. Fill in user details:
    ...
    - **Email verified**: `ON`
    - **Enabled**: `ON`
    - First name and last name are NOT optional
...
PWD="a"
CLIENT_SECRET="3xK9ilcgXgl7Vt8RNJSxhRpA9RqJOYOE"
...
### Issue 1: "unauthorized_client" or "Invalid client credentials"

**This is the most common error!** It means Keycloak doesn't recognize your client or the credentials are wrong.
...
4. **Wrong Realm Name in URL**
   - Your curl uses: `http://localhost:8090/realms/drive/protocol/openid-connect/token`
   - Make sure the realm name `drive` exists and matches EXACTLY
...
### Issue 4: "Access denied" / 403 Forbidden
...
### Issue 5: Connection refused to Keycloak

- Ensure Keycloak is running
- Verify the URL and port are correct
- Check firewall settings

### Issue 6: "invalid_grant" or "Invalid user credentials"

- Username or password is incorrect
- User is disabled in Keycloak
- User doesn't have a password set
- User doesn't exist in the specified realm
